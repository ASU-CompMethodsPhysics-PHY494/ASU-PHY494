...
import it and use the functions in the module.

You should be able to do use your functions in the following manner 
{% highlight python %}
y = [myfuncs.heaviside(x) for x in range(-10, 11)]
print("Heaviside: {}".format(y))

t_boil = myfuncs.kelvin2celsius(373.15)
print("Water boils at {.2f} C".format(t_boil))
{% endhighlight %}
